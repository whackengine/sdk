...
lazy_static! {
    pub static ref DATA: HashMap<i32, String> = hashmap! {
        ...
        WhackDiagnosticKind::RecordClassMustExtendObject.id() => "Record class must extend Object.".into(),
        ...
        WhackDiagnosticKind::RecordClassMustHaveEmptyConstructor.id() => "Record class must have empty constructor.".into(),
